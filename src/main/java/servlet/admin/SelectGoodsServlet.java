...
public class SelectGoodsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (act == null) act = (String)request.getAttribute("act");
		//条件查询
		String gname = request.getParameter("gname");
		if (gname == null) gname = (String)request.getAttribute("gname");
		String typeid = request.getParameter("typeid");
		if (typeid == null) typeid = (String)request.getAttribute("typeid");
		//在条件查询分页URL中使用
